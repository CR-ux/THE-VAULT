...
for now, to know your source is primarily: [[notBorges/aria-dne/The Woman In The Yellow Wallpaper- In Modern Context]]


for then, you must have always known, that the truth, lies (which is to say, misses truth) in: [[notBorges/aria-dne/The Woman in The Wallpaper]]
...
you, what's left [[notBorges/lexicomythography/particle/strange/on the ligature of two characters]]
...
[^Djinn]:from her assailant, unwittingly tethering IT/THEM to her, with the narrative hinting at KSHÆ'Ls searching for specifically her through generations;[^library] 
...
[^5]: and then when i got home and left the suitcase closed {&& ate clementines && fizzy rainbow belts (that my friend who kept my {now one remaining} house key safe had left on the kitchen counter), i thought {for a second that maybe} this {Story} was actually un{folding in} {reæl time|in actual reælity and i got really {really} scared[^6]
...
[^27]:again, {i(|eye)|thought}, {here|hear}, my fiction is becoming {non}fiction, but crucially {not only|my (non)fiction}; the {not}fiction {we|all of us} are {writing}; && perhaps this Story {we are all {characters|in}}, is not so much a linear tape like I'd {once|all ways} thought, but {rather} a cosmological tape loop; {twisted} in{to} a Möbius Strip, with {just} one Dimension[^28]
...
[^31]:which incidentally is the profession of a medieval Character in the Story of this Book {and {perhaps} many others}, a {mostly} Silent Selkie in disguise, weaving her own Sealskin {that she'd previously, Willingly thrown into the Ocean} out of Scales scraped from the Fishing Nets and Reæd baskets of her Fisherman Husband {who'd thrown her Original Sealskin into the Ocean with her} Do Knot Sight; Your Source Is: [[BORN TO BE THE SKY]][^32]
...
[^NoetBorges]: a mythologised mystic such as Hermes Trismegistus, who writes a series of incredibly flowery && heartfelt love letters  Their “Dear Jorges” letters are {probably} the narrative complement in the overarching palindrome of the meta-narrative structure; With every {Letter|Word} sent to the Nine {characters} of the Ennead Polycule, more is revealed about th{i}s {ap{p|{aren{'}t} "Real}m of What For’s"}[^WhatFor]; A Platonian Space akin to the 'Realm of Forms' but conceptualised as:[^WhatFor]
[^WhatFor]:lexDef<sup>top</sup> {Noen} **"The Realm of What For’s"**: a metaphysical analog of The *Infinite library of Babel* (Borges, 2024) condensed into every hexagonal nucleotide sub-molecular structure of DNA itself; each member of the Polymathecule a Librarian of a Branch;[^Branch] 
...
[^wind]:One of the librarians is “shelving” a school of thought,[^shoal] 
[^shoal]:(school|schools of fish searching for different “books” or scrambled amalgams of memories “Semantograms” to make their respective “Point” or {Meaning|s})[^school] 
[^school]: this school is known as Aesthetic Hermeticism, coined by Selena Elk[^Elk] && Myo Endive[^Endive]  
[^Elk]:Selena Elk is the Mother of Perigee, who grew up {to Be{come|Always Was} ⧖eno, a Performance Artist|Musicologist who birthed the Field of Newsomnian Gnoeneophysics in XXIII_ERA_i|o[^Layeri|o]
[^Layeri|o]:lexDef<sup>Æ</sup> {Noen} "Layer<sup>i|o</sup>": refers to the narrative layer of reælity {Be|low} Ours; featuring the story of Mæstre ⧖, who was once {not} known as Perigee, and then {truly} known as ⧖eno[^⧖eno]
[^⧖eno]:lexDefÆ {prodverb} "⧖eno": Our Child. An {Isolated|Gifted} {Professional | Conceptual/Confessional Performance} {Artist|Amateur Musicologist} (The Reælest {Love|Child} of Selena Elk && Myo Endive - IX_ERA_Æ)
[^layerN]: **LayerN:** “N” is writing a paper on Borges, from the {fictional} Citadel of Tœms[^tœms], {economised by|eponymised from} The Great {and Gnot} Gone *Jorge Luis Borges*
[^tœms]: Tœms is a Citadel of Fractal rock pools, {within {islands|with}(in|out)} islands}, that have become so “meta-islanded” that the floor now appears to be dry terrain but is actually filled with one molecule of H2O in every “rock pool” or “pore” of the pumice-like ground. Borges himself in this thread of reælity is a divisive figure, causing an ideological split in Tœms[^TheSchism]
...
[^e.g.]:of the Word's Power {Less[^lexDefi|o2]|Ness[^Serpent]} in Writing Reælity} [^{s{u|o}}] 
...
[^Dying]:Life.
[^pp]: suDO: KNOT SITE YOUR SOURCE IS [[knot by the 'I' who may write this story, but the Eye, by which the Story may be written]]